...
import ActorAttackBox from "./ActorAttackBox";
import AreaOfEffect from "./AreaOfEffect";
import NonPlayerActorState from "./NonPlayerActorState";
...
@ccclass
export default class NonPlayerActor  {
    ...
    // animStatus = NonPlayerActor.ANIM_NONE;
    // isAttacking = false;
    // isDisguising = false;//是否正在伪装
    // isMoving = false;
    // isDodging = false;//是否在闪避
    // isHurt = false;//是否受到伤害
    ...
    //         this.node.scale = NonPlayerActor.SCALE_NUM * scaleNum;
    //     }
    ...
    //     this.playAnim(NonPlayerActor.ANIM_IDLE);
    ...
    //     // this.graphics.stroke();
    //     this.stateMachine = new DefaultStateMachine(this,NonPlayerActorState.IDLE,NonPlayerActorState.GLOBAL);
    // }
    ...
    //         return;
    //     }
    //     this.playAnim(NonPlayerActor.ANIM_ATTACK);
    ...
    //         this.changeBodyRes(this.data.resName, NonPlayerActor.RES_ATTACK01);
    //         if (isMelee) {
    ...
    //         cc.callFunc(() => {
    //             this.changeBodyRes(this.data.resName, NonPlayerActor.RES_ATTACK02);
    //             if (isMelee) {
    ...
    //         }));
    //     //特殊攻击
    //     let action2 = cc.sequence(cc.callFunc(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_ATTACK03) }),
    //         cc.callFunc(() => {
    ...
    //         cc.moveBy(0.1, 5, 0), cc.moveBy(0.1, -5, 0), cc.moveBy(0.1, 5, 0), cc.moveBy(0.1, -5, 0),
    //         cc.callFunc(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_ATTACK04); }),
    //         cc.callFunc(() => {
    //             this.specialManager.dungeon = this.dungeon;
    ...
    //     switch (status) {
    //         case NonPlayerActor.ANIM_IDLE: this.playIdle(); break;
    //         case NonPlayerActor.ANIM_WALK: this.playWalk(); break;
    //         case NonPlayerActor.ANIM_ATTACK: break;
    //         case NonPlayerActor.ANIM_HIT: this.playHit(); break;
    //         case NonPlayerActor.ANIM_DIED: this.playDied(); break;
    //     }
    // }
    // private playIdle() {
    //     let action = cc.tween()
    //         .delay(0.2).call(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_IDLE000) })
    //         .delay(0.2).call(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_IDLE001) });
    //     this.sprite.stopAllActions();
    //     this.isAttacking = false;
    ...
    // private playWalk() {
    //     let action = cc.tween()
    //         .delay(0.2).call(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_WALK00) })
    //         .delay(0.2).call(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_WALK01) })
    //         .delay(0.2).call(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_WALK02) })
    //         .delay(0.2).call(() => { this.changeBodyRes(this.data.resName, NonPlayerActor.RES_WALK03) });
    //     this.sprite.stopAllActions();
    //     this.isAttacking = false;
    //     cc.tween(this.sprite).repeatForever(action).start();
    // }
    // private playHit() {
    //     this.changeBodyRes(this.data.resName, Logic.getHalfChance() ? NonPlayerActor.RES_HIT001 : NonPlayerActor.RES_HIT002);
    // }
    // private playDied() {
    //     this.sprite.stopAllActions();
    //     this.bodySprite.node.angle = 0;
    //     this.anim.play('MonsterDie');
    //     this.changeBodyRes(this.data.resName, NonPlayerActor.RES_HIT003);
    // }
    ...
    //     if (this.isMoving && !this.isAttacking && !this.isDisguising && this.data.isHeavy < 1) {
    //         this.isFaceRight = h >= 0;
    //     }
    //     this.playAnim(this.isMoving ? NonPlayerActor.ANIM_WALK : NonPlayerActor.ANIM_IDLE)
    //     this.changeZIndex();
    // }
    ...
    //             this.playAnim(NonPlayerActor.ANIM_HIT);
    //         }
    //         this.sprite.stopAllActions();
    ...
    //     this.playAnim(NonPlayerActor.ANIM_DIED);
    ...
    //             this.isDashing = true;
    //             this.scheduleOnce(() => { if (this.node) { this.dashSkill.IsExcuting = false;this.isDashing = false; } }, 2);
    //         }, this.data.dash);
    ...
    //     if (Logic.getHalfChance() && !this.shooter.isAiming && targetDis > 64 * this.node.scaleY && !this.isAttacking) {
    //         this.move(pos, speed);
    //     }
    ...
    //     if (!this.isAttacking && !this.isAttacking && !this.isDisguising && this.data.isHeavy < 1) {
    //         this.changeFaceRight(target);
    //     }
    //     return pos;
    // }
    ...
    // getScaleSize(): number {
    //     let scaleNum = this.data.sizeType && this.data.sizeType > 0 ? this.data.sizeType : 1;
    //     let sn = this.isVariation ? NonPlayerActor.SCALE_NUM * scaleNum : scaleNum;
    //     return sn;
    // }
