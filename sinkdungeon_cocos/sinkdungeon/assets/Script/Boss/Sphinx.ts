...
export default class Sphinx extends Boss {
    ...
    summonMonster() {
        ...
        this.summonSkill.next(() => {
            ...
            this.dungeon.monsterManager.addMonsterFromData(MonsterManager.MONSTER_SANDSTATUE, cc.v3(pos.x, pos.y - 1),this.dungeon);
            this.dungeon.monsterManager.addMonsterFromData(MonsterManager.MONSTER_SANDSTATUE, cc.v3(pos.x+1, pos.y - 1),this.dungeon);
            this.dungeon.monsterManager.addMonsterFromData(MonsterManager.MONSTER_SANDSTATUE, cc.v3(pos.x-1, pos.y - 1),this.dungeon);
            this.dungeon.monsterManager.addMonsterFromData(MonsterManager.MONSTER_ANUBIS, cc.v3(pos.x-1, pos.y - 2),this.dungeon);
            this.dungeon.monsterManager.addMonsterFromData(MonsterManager.MONSTER_ANUBIS, cc.v3(pos.x+1, pos.y - 2),this.dungeon);
        }, 15, true);
    }
    fireStorm() {
