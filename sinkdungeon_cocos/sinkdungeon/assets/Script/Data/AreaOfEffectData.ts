...
export default class AreaOfEffectData {
    ...
    statusList:string[] = [];
    init(duration:number,interval:number,delay:number,scale:number,zIndex:number,isFromEnemy:boolean,canBreakBuilding:boolean,canBreakBullet:boolean,canBeatBack:boolean,isRotate:boolean,damage:DamageData,from:FromData,statusList:string[]):AreaOfEffectData{
