...
export default class AvatarSpriteData {
    ...
    static readonly ITEM4 = 'item4'
    static readonly ITEM5 = 'item5'
    static readonly ITEM6 = 'item6'
    resId: string
    count: string
    type: string
    valueCopy(data: AvatarSpriteData) {
        if (!data) {
            return
        }
        DataUtils.baseCopy(this, data)
    }
    clone(): AvatarSpriteData {
        let e = new AvatarSpriteData()
        e.valueCopy(this)
        return e
    }
}
