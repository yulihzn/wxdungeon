...
export default class DungeonStyleManager extends BaseManager {
    ...
    runBackgroundAnim(resName: string) {
        ...
        if (!spf2) {
            spf2 = Logic.spriteFrameRes(resName)
        }
        if (!spf1) {
            return
        }
    ...
    addDecorations() {
        switch (Logic.chapterIndex) {
            ...
            case Logic.CHAPTER01:
                this.styleData = new DungeonStyleData('sea', 'shipwall1', 'shipsides', 'shipdoor', 'shipdoorframe', '#000000', 'tile_deck001')
                break
            case Logic.CHAPTER02:
                this.styleData = new DungeonStyleData('grass', 'junglewall1', 'junglesides', 'jungledoor', 'jungledoorframe', '#000000', 'tile_dirt001')
                break
            case Logic.CHAPTER03:
                this.styleData = new DungeonStyleData('sandsea', 'pyramidwall1', 'pyramidsides', 'pyramiddoor', 'pyramiddoorframe', '#000000', 'tile003')
                break
            case Logic.CHAPTER04:
                this.styleData = new DungeonStyleData('magmasea', 'dungeonwall1', 'dungeonsides', 'dungeondoor', 'dungeondoorframe', '#000000', 'tile004')
                break
