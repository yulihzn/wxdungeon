...
export default class SpecialManager extends cc.Component {
        ...
        switch (placeType) {
            ...
            case SpecialManager.AFTER_ASH:
                this.addAoe(
                    ...
                    new AreaOfEffectData().init(
                        ...
                        0.1,
                        isVariation ? 4 : 3,
                        IndexZ.getActorZIndex(this.node.parent.position),
                        true,
                        true,
                        true,
                        false,
            ...
            case SpecialManager.AFTER_ICE:
                ...
                this.addAoe(
                    ...
                    ['ice001', 'ice002', 'ice002', 'ice003', 'ice004'],
                    false,
                    isFaceRight
                )
            ...
            case SpecialManager.AFTER_SWORD:
                ...
                this.addAoe(
                    ...
                    ['specialswordlight001', 'specialswordlight002', 'specialswordlight003', 'specialswordlight004'],
                    false,
                    isFaceRight
                )
                break
    ...
    private addHowl(pos: cc.Vec3, isFaceRight: boolean, from: FromData, isVariation: boolean) {
        ...
        howlScript.show(
            ...
            cc.v2(1, 0),
            0,
            new AreaOfEffectData().init(0, 2, 1.5, isVariation ? 3 : 2, IndexZ.getActorZIndex(howl.position), true, false, true, false, false, new DamageData(1), from, [
                StatusManager.DIZZ
            ])
        )
    }
    private addClaw(pos: cc.Vec3, isFaceRight: boolean, from: FromData, isVariation: boolean) {
        ...
        areaScript.show(
            ...
            cc.v2(1, 0),
            0,
            new AreaOfEffectData().init(0, 0.15, 0.1, isVariation ? 2 : 1, IndexZ.getActorZIndex(claw.position), true, false, true, false, false, new DamageData(2), from, [
                StatusManager.BLEEDING
            ])
        )
    }
    ...
    private addBlade(pos: cc.Vec3, isFaceRight: boolean, from: FromData, isVariation: boolean) {
        ...
        areaScript.show(
            ...
            cc.v2(1, 0),
            0,
            new AreaOfEffectData().init(0, 0.2, 0.1, isVariation ? 2 : 1, IndexZ.getActorZIndex(prefab.position), true, false, true, false, false, new DamageData(2), from, [])
        )
    }
}
