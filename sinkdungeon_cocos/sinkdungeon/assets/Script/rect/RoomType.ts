...
export default class RoomType {
    ...
    static isMonsterGenerateRoom(roomType: RoomType) {
        ...
        return (
            ...
            RoomType.LOOT_ROOM.isEqual(roomType) ||
            RoomType.NORMAL_ROOM.isEqual(roomType) ||
            RoomType.END_ROOM.isEqual(roomType) ||
            RoomType.VERTICAL_ROOM.isEqual(roomType) ||
            RoomType.HORIZONTAL_ROOM.isEqual(roomType)
        )
    }
