...
export default class DollMachineDialog extends BaseDialog {
    ...
    onLoad() {
        ...
        EventHelper.on(EventHelper.KEYBOARD_INTERACT, detail => {
            if (this.node && this.node.active) {
                this.buttonClick()
            }
        })
    ...
    private joystickMove(pos: cc.Vec3) {
        ...
        let movePos = Utils.clampPos(
            this.hook.position.add(pos.mul(10)),
                ...
                cc.tween(this.clawCenter)
                    ...
                    .call(() => {
                        ...
                        cc.tween(this.claw)
                            .call(() => {
                                cc.tween(this.hook)
                                    .to(this.hook.position.mag() / 120, { position: cc.v3(this.hook.width / 2, this.hook.height / 2) })
                                    .call(() => {
                                        isFinish1 = true
                                        if (isFinish2) {
