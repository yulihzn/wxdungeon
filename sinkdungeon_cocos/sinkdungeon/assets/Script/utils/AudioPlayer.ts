...
export default class AudioPlayer extends cc.Component {
    ...
    public static readonly JUMP_WATER = 'JUMP_WATER'
    ...
    @property(cc.AudioClip)
    jumpwater: cc.AudioClip = null
    @property(cc.AudioClip)
    swimming: cc.AudioClip = null
    @property(cc.AudioClip)
    ...
    onLoad() {
        ...
        this.audioList[AudioPlayer.JUMP_WATER] = this.jumpwater
        this.audioList[AudioPlayer.SWIMMING] = this.swimming
    }
    playbg() {
