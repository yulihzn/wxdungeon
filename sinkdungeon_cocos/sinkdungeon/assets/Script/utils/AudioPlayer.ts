...
export default class AudioPlayer extends cc.Component {
    ...
    public static readonly DASH = 'dash1'
    ...
    public static readonly ATTACK_ELECTRIC = 'attackelectric'
    public static readonly ATTACK_ICE = 'attackice'
    public static readonly ATTACK_TOXIC = 'attacktoxic'
    public static readonly ATTACK_FIRE = 'attackfire'
    public static readonly ATTACK_CURSE = 'attackcurse'
    public static readonly ATTACK_BLEEDING = 'attackbleeding'
    ...
    public static readonly MELEE_REFLECT_WOOD1 = 'meleereflectwood1'
    public static readonly MELEE_REFLECT_WOOD2 = 'meleereflectwood2'
    public static readonly MELEE_REFLECT_WOOD3 = 'meleereflectwood3'
    ...
    public static readonly STRIKEIRON = 'strikeiron'
    public static readonly STRIKEIRON1 = 'strikeiron1'
